...
Скрипт поддерживает любой порядок столбцов, главное, чтобы названия не менялись и обязательно были следующие столбцы: chr_original, pos_start_original, pos_end_original, chr_id, pos_start, pos_end.
